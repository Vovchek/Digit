...
# Build script for FringesCore library
...
Write-Info "FringesCore Build Script"
Write-Info "========================="
Write-Info ""
...
try {
    $CMakeArgs = @(
        ...
        "-DFRINGES_BUILD_TESTS=ON"
        "-DFRINGES_BUILD_LEGACY=ON"
        "-DFRINGES_BUILD_DOCS=ON"
    )
...
# Build
Write-Info "Building FringesCore ($BuildType)..."
try {
...
if ($Install) {
    Write-Info "Installing FringesCore..."
    try {
