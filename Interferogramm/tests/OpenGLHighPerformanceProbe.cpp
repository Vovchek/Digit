...
int main()
{
    ...
    wc.lpszClassName = "OpenGLHighPerformanceProbeWindow";
    ...
    std::cout << "\nThis executable exports NvOptimusEnablement and AmdPowerXpressRequestHighPerformance.\n";
    std::cout << "Drivers may use those hints to prefer the discrete GPU for this process.\n";
